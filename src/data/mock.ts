...
export const permissionCatalog: PermissionGroup[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "knowledge.approve", label: "بررسی، تأیید و انتشار اسناد" },
      { id: "knowledge.archive", label: "آرشیو و بازیابی اسناد" },
      { id: "knowledge.confidential", label: "مشاهده‌ی اسناد محرمانه" },
      { id: "knowledge.registry", label: "مدیریت شناسنامه‌ها" },
      { id: "knowledge.rnd", label: "مدیریت سندهای فرصت تحقیق و توسعه" },
      { id: "knowledge.processes", label: "مدیریت فرآیندها" },
      { id: "knowledge.experiences", label: "ثبت و انتشار تجربیات و درس‌آموخته‌ها" },
      { id: "knowledge.experts", label: "مدیریت خبرگان" },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "projects.archive", label: "بایگانی و بازیابی پروژه" },
      { id: "projects.tasks", label: "ایجاد و تخصیص وظایف" },
      { id: "projects.tasks.delete", label: "حذف وظایف" },
      { id: "projects.progress", label: "ثبت گزارش پیشرفت" },
      { id: "projects.members", label: "مدیریت اعضا و نقش‌های پروژه" },
      { id: "projects.budget", label: "تعیین بودجه و سرفصل‌های مالی" },
      { id: "projects.expenses", label: "ثبت و ویرایش هزینه‌ها" },
      { id: "projects.expenses.approve", label: "تأیید و پرداخت هزینه‌ها" },
      { id: "projects.risks", label: "مدیریت ریسک‌ها و مشکلات" },
      { id: "projects.meetings", label: "مدیریت جلسات و صورت‌جلسات" },
      { id: "projects.documents", label: "مدیریت اسناد پروژه" },
      { id: "projects.templates", label: "مدیریت قالب‌های پروژه" },
      { id: "projects.groups", label: "مدیریت گروه‌های پروژه" },
      { id: "projects.playbooks", label: "اجرا و مدیریت Playbook" },
      { id: "projects.notifications", label: "قواعد اعلان و خودکارسازی" },
      { id: "projects.reports", label: "مشاهده گزارش‌ها و خروجی" },
      { id: "projects.history", label: "مشاهده تاریخچه رویدادها" },
    ],
  },
  {
    id: "contracts",
...
/**
 * پرسوناهای نمایشیِ منتخب برای دمو — هر کدام یک سطحِ دسترسیِ متفاوت تا با ورود
 * به‌عنوانِ آن‌ها، تفاوتِ «کی چه کاری می‌تواند بکند» به‌روشنی دیده شود.
